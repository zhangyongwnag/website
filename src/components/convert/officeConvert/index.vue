<template>
  <div class="scroll_wrap _common_scroll_wrap">
    <div class="convert_wrap">
      <div class="_common_block _flex_column_center" v-for="(item,index) in office_list" @click="handle_click(item,index)">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // 过滤office列表
      office_list() {
        return this.convert_list.filter(item => item.type == 'office')
      },
    },
    methods: {
      /**
